...
this has to use a binary search cuz it's looking for O(logn)\\

\end{solution}

\begin{solution}{2.a}

I learned r/b trees last year, I can do this on paper in like 10 minutes - W\\

\end{solution}

\begin{solution}{2.b}

I can do this one too - W\\
